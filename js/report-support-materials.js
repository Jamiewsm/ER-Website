  ...
  const MATERIALS = [
    {
      ...
      reportSummary: "모임에서의 역할이나 분위기, 내 행동이 다른 사람에게 미치는 영향을 놓치기 쉬울 수 있습니다. 사람을 싫어한다는 뜻은 아닙니다. 관계가 많아질수록 서로 맞춰 가는 데 더 많은 노력이 필요할 수 있습니다.",
      focusAreas: ["집단 안에서 내 위치와 역할 감각", "직설성과 관계적 전달 방식의 균형", "자녀나 팀원이 겪는 사회적 감정의 무게"],
      practicePrompts: ["내 의도와 상대가 경험한 영향을 함께 점검하기", "회의나 모임에서 내 의견을 한 번은 말하기", "아이가 친구 관계로 힘들어할 때 해결책보다 공감의 말을 먼저 건네기"],
      typeSpecificTitles: {
        1: "생각을 거르지 않고 비판하는 사람",
    ...
    },
    {
      ...
      resultSlots: ["instinct_profile", "relationship_pattern", "parenting_pattern", "recommended_resources"],
      reportSummary: "누군가에게 먼저 다가가 깊이 대화하거나 감정을 직접 표현하는 일이 부담스러울 수 있습니다. 애정이 없다는 뜻은 아닙니다. 감정이 강하게 오가는 관계에서 쉽게 지칠 수 있습니다.",
      focusAreas: ["일대일 관계에서 먼저 다가가는 힘", "갈등이 생겼을 때 물러남과 회피의 구분", "함께 시간을 보내며 애정을 전하는 방법"],
      practicePrompts: ["짧지만 집중된 10분 대화 만들기", "불편한 마음을 덮어 두기 전에 한 문장으로 표현하기", "맡은 일을 하는 데 더해, 말과 행동으로 애정을 표현하기"],
      typeSpecificTitles: {
        1: "분노를 안으로 삼키는 1번",
    ...
    },
    {
      ...
      audiences: ["adult", "parent", "coach"],
      resultSlots: ["instinct_profile", "relationship_pattern", "parenting_pattern", "recommended_resources"],
      reportSummary: "건강, 돈, 시간, 안전처럼 내 생활을 돌보는 일을 뒤로 미루기 쉬울 수 있습니다. 생활 능력이 없다는 뜻은 아닙니다. 필요한 것을 알아차려도 실제로 챙기기까지 시간이 걸릴 수 있습니다.",
    ...
    },
    {
      ...
      reportSummary: "부모 자신의 핵심 유형이 자녀에게 주는 강점과, 스트레스를 받을 때 나타날 수 있는 어려움을 함께 점검합니다.",
      focusAreas: ["자녀가 받는 긍정적 영향", "부모의 성향 때문에 양육에서 어려워지는 점", "오늘부터 조정할 실천 전략"],
    ...
    },
    {
      ...
      focusAreas: ["아이에게 특히 상처가 되는 말", "핵심 두려움을 건드리지 않는 표현", "있는 그대로 소중하다고 전하는 말"],
    ...
    },
    {
      ...
      focusAreas: ["싸움이 터진 첫 30초", "서로의 감정을 듣도록 돕기", "강요 없는 회복과 가족 규칙 만들기"],
      practicePrompts: ["누가 먼저인지 묻기 전에 몸싸움부터 멈추기", "두 아이의 감정을 각각 한 문장으로 짚어 주기", "반복 갈등은 멘트가 아니라 규칙으로 정리하기"],
      typeSpecificTitles: {}
    }
  ];
