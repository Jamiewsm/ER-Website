...
(function () {
  ...
  var S = {
    ...
    contentData: {
      ...
      notices: [
        { id: 4, tag: '모집중', title: 'Enneagram for Parents — 6월 4주 워크샵 모집', date: '2026-06-01', summary: '나를 알고, 아이를 이해하는 4주 자녀양육 심화 워크샵 — 부모의 자기이해와 복음적 회복의 관점', body: '<p class="text-gray-600 leading-relaxed break-keep">양육의 변화는 부모의 자기이해에서 시작됩니다. <strong>Enneagram for Parents</strong>는 에니어그램 입문이 아닌 심화 과정으로, 자신의 유형을 어느 정도 알고 계신 부모님이 반복되는 양육 반응을 성찰하고 자녀를 새롭게 바라보는 4주 워크샵입니다.</p><div class="mt-6 grid gap-3"><div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100"><span class="text-xs font-bold text-gray-500 w-20">기간</span><span class="text-sm text-gray-700 break-keep">6월 셋째 주–7월 둘째 주 (일정 확정 후 안내)</span></div><div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100"><span class="text-xs font-bold text-gray-500 w-20">대상</span><span class="text-sm text-gray-700 break-keep">ER 강의·세션 등을 통해 유형을 어느 정도 알고 계신 부모님</span></div><div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100"><span class="text-xs font-bold text-gray-500 w-20">구성</span><span class="text-sm text-gray-700 break-keep">4주 / 총 10시간 · 주 1회 온라인 Zoom · $120</span></div><div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100"><span class="text-xs font-bold text-gray-500 w-20">모집</span><span class="text-sm text-gray-700 break-keep">소규모 선착순</span></div></div><p class="mt-6"><a href="/parents-brochure.html" class="inline-flex items-center justify-center rounded-full border border-er-accent/40 bg-er-accentLight/30 px-5 py-2.5 text-sm font-bold text-er-dark hover:border-er-accent transition-colors">모바일 브로셔 보기</a></p>' },
