...
(function () {
  ...
  var S = {
    ...
    publicTestimonials: {
      ...
      stories: [
        { tag: '선교·사역', quote: '사역과 육아로 분주한 삶 속에서 나 자신을 성찰하는 시간을 따로 내기 어려웠지만, 8주 동안 하나님이 저를 위로하고 격려하시는 따뜻한 손길을 느꼈습니다.', person: '김00', meta: '샌안토니오 · 사역자' },
        { tag: '가정 회복', quote: '이해되지 않던 배우자를 더 쉽게 이해하게 되었고, 갈등과 오해를 줄이기 위해 어떻게 말하고 반응해야 하는지 실제적인 방향을 얻게 되었습니다.', person: '강00', meta: '아프리카 · 선교 현장' },
        { tag: '자기 이해', quote: '오랜 시간 궁금했던 나의 유형과 기질을 더 분명히 이해하게 되었고, 나를 정죄하기보다 받아들이며 건강한 방향으로 나아갈 수 있겠다는 소망이 생겼습니다.', person: '이00', meta: '서울 · 개인 상담' },
        { tag: '부부·공동체', quote: '아내와 함께 상담을 받으며 서로를 더 존중하고 세워 줄 수 있는 언어를 배웠고, 공동체 안에서도 이해의 폭이 넓어질 수 있겠다는 확신이 생겼습니다.', person: '조00', meta: '보스턴 · 가정과 공동체' },
        { tag: '상담 깊이', quote: '분석지 해석에 머물지 않고 실제 인생 이야기를 나누며 근원적인 정체성을 함께 찾아가는 전인격적 상담이라는 인상을 받았습니다.', person: '배00', meta: '부산 · 상담 후기' },
        { tag: '자기 수용', quote: '스스로를 객관적으로 보게 되었고, 유익하지 않은 생각과 습관을 알아차리며 소명의 언어를 돌아보는 데 실제 도움이 되었습니다.', person: '이00', meta: '서울 · 강의/상담 후기' },
        { tag: '가정 회복', quote: '사춘기 딸과 감정적으로 자꾸 부딪히며 "이 아이는 왜 이런 생각과 행동을 할까" 고민이 많던 때 애니어그램을 알게 되었습니다. 처음엔 아이를 알고 싶다는 마음으로 시작했지만, 나 자신을 관찰하고 성찰하면서 제 기질과 고착이 아이와의 소통에 어떤 영향을 주고 있었는지 스스로 깨닫게 되었습니다. 아이의 깊은 내면을 이해하게 되니, 예전엔 화가 났던 것들도 자연스럽게 넘길 수 있는 이해의 폭이 생겼습니다. 애니어그램은 자녀를 사랑으로 잘 키우고 싶은 부모에게 좋은 방향을 제시해 주는 도구라고 생각합니다.', person: '서--', meta: '달라스 · 우리 아이가 달라졌어요' }
      ]
    },
