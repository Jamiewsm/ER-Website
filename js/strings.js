...
(function () {
  ...
  var S = {
    ...
    contentData: {
      ...
      notices: [
        { id: 8, tag: '모집중', title: '에니어그램 기본과정 8주 — 10월 기수 모집', date: '2026-08-27', summary: '10월 첫주 개강 · 선착순 8명 · 얼리버드 ₩380,000 / $270 (9/17까지)', body: '<p class="text-gray-600 leading-relaxed break-keep"><strong>2026년 10월 ER 성경적 에니어그램 기본과정</strong> 모집을 시작합니다. 관계 속에서 드러나는 나를 이해하고, 하나님 안에서 본래의 나로 회복되는 8주 온라인 과정입니다.</p><div class="mt-6 grid gap-3"><div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100"><span class="text-xs font-bold text-gray-500 w-20">개강</span><span class="text-sm text-gray-700 break-keep">2026년 10월 첫주 (요일·시간은 참여자와 조율)</span></div><div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100"><span class="text-xs font-bold text-gray-500 w-20">정원</span><span class="text-sm text-gray-700 break-keep">선착순 8명 · 입금 확인 순 확정</span></div><div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100"><span class="text-xs font-bold text-gray-500 w-20">구성</span><span class="text-sm text-gray-700 break-keep">8주 · 주 1회 강의 3시간 + 1:1 멘토링 1시간</span></div><div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100"><span class="text-xs font-bold text-gray-500 w-20">수강료</span><span class="text-sm text-gray-700 break-keep">한국 ₩420,000 / 해외 $300 · 9월 17일까지 ₩380,000 / $270</span></div></div><p class="mt-6 flex flex-wrap gap-3"><a href="/basic-course.html" class="inline-flex items-center justify-center rounded-full bg-er-dark text-white px-5 py-2.5 text-sm font-bold shadow-soft hover:bg-gray-800 transition-colors">과정 안내 보기</a><a href="/#apply?track=paid&focus=enneagram_basic_october" class="inline-flex items-center justify-center rounded-full border border-er-accent/40 bg-er-accentLight/30 px-5 py-2.5 text-sm font-bold text-er-dark hover:border-er-accent transition-colors">지금 신청하기</a></p>' },
        ...
        { id: 5, tag: '축하', title: '에니어그램 기본과정 수료 — 7명', date: '2026-06-10', summary: '기본과정 수료생 7분이 8주 과정을 마치고 다음 단계로 나아갑니다', body: '<p class="text-gray-600 leading-relaxed break-keep"><strong>ER 에니어그램 기본과정</strong> 수료를 축하드립니다. 8주 동안 이론과 적용, 멘토링을 함께 걸어온 <strong>7분</strong>이 과정을 마치고 스터디·코칭스쿨 등 다음 여정으로 이어갑니다.</p><p class="mt-4 text-sm text-gray-600 leading-relaxed break-keep">수료생 여러분의 회복 사역을 응원합니다. 앞으로도 ER 공동체 안에서 서로 세워 주는 동역이 이어지기를 바랍니다.</p>' },
    ...
    programs: {
      ...
      view: {
        ...
        training: {
          title: 'ER 전문가 과정',
          desc: '에니어그램 기본과정부터 스터디와 1년 코칭스쿨까지 이어지는 전체 훈련 여정입니다.',
          cards: [
            { b: 'Foundation', t: '에니어그램 기본과정', d: '8주 동안 핵심 이론과 ER 관점을 배우고 실제 적용의 기초를 세웁니다.', i: 'fas fa-chalkboard' },
            { b: 'Study', t: '팔로우업 스터디', d: '기본과정 수료 후 격주 스터디로 학습과 현장 적용을 이어갑니다.', i: 'fas fa-book-reader' },
            { b: 'Coaching School', t: '1년 코칭스쿨', d: 'Formation, 전문 강사, 코칭 스킬, 통합 실습을 함께 이수합니다.', i: 'fas fa-user-md' }
          ]
        }
      }
    },
