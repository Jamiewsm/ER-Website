...
(function () {
  ...
  var S = {
    ...
    publicTestimonials: {
      ...
      stories: [
        { tag: '자기이해', quote: '유형을 안다고 생각했지만 감정 반응의 뿌리가 늘 헷갈렸습니다. 상담에서 혼동되는 유형을 구분하는 질문을 따라가며 제 핵심 동기를 더 선명하게 정리했고, 이후 중요한 관계와 선택에서 스스로를 설명하는 기준이 생겼습니다.', person: '00', meta: '부산 · 개인 상담' },
        { tag: '선교·사역', quote: '제 성향이 왜 상황마다 달라 보이는지 스스로도 설명하기 어려웠습니다. 상담을 통해 고유한 강점과 반복되는 고착 패턴을 분리해서 보게 되었고, 사역 현장에서 제 리더십과 소통 방식을 더 명확하게 조정할 수 있었습니다.', person: '00', meta: '중앙아시아 · 사역 현장' },
        { tag: '자기성찰', quote: '문제가 성품의 이슈인지, 유형의 비통합 반응인지 구분이 안 되어 자주 자책했습니다. 상담 이후 비통합으로 내려갈 때의 신호를 먼저 알아차리게 되었고, 말과 행동을 점검하는 실제 루틴이 생겨 관계 갈등이 줄었습니다.', person: '00', meta: '서울 · 코칭 사역' },
        { tag: '부부관계', quote: '아내와의 차이를 자꾸 문제로 해석하다 보니 대화가 반복해서 막혔습니다. 부부가 함께 상담을 받으며 서로의 기질 차이를 이해하게 되었고, 상대를 바꾸려 하기보다 존중하는 대화 방식으로 전환할 수 있었습니다.', person: '00', meta: '보스턴 · 부부 상담' },
        ...
        { tag: '양육상담', quote: '세 자녀를 같은 방식으로 양육하면 된다고 생각했는데, 아이마다 필요한 반응이 달라 계속 부딪혔습니다. 상담을 통해 부모의 반응 패턴과 아이들의 기질 차이를 함께 이해하면서, 각 아이에게 맞는 양육 언어를 적용할 수 있게 되었습니다.', person: '00', meta: '달라스 · 자녀 양육' },
        { tag: '부부관계', quote: '결혼 생활에서 아내의 반응을 이해하지 못해 오해가 쌓이고 있었습니다. 상담과 강의를 통해 기질의 다름을 우열이 아닌 차이로 받아들이게 되었고, 갈등 상황에서도 상대 강점을 먼저 보는 대화로 바뀌었습니다.', person: '00', meta: '달라스 · 부부 관계' }
      ]
    },
