...
(function () {
  ...
  var S = {
    ...
    contentData: {
      ...
      notices: [
        { id: 8, tag: '모집중', title: '에니어그램 기본과정 8주 — 10월 기수 모집', date: '2026-08-27', summary: '10월 첫주 개강 · 클래스당 7명 · 분반 가능 · 한국 ₩450,000 / 미국 $330', body: '<p class="text-gray-600 leading-relaxed break-keep"><strong>2026년 10월 ER 성경적 에니어그램 기본과정</strong> 모집을 시작합니다. 관계 속에서 드러나는 나를 이해하고, 하나님 안에서 본래의 나로 회복되는 8주 온라인 과정입니다.</p><div class="mt-6 grid gap-3"><div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100"><span class="text-xs font-bold text-gray-500 w-20">개강</span><span class="text-sm text-gray-700 break-keep">2026년 10월 첫주 (요일·시간은 참여자와 조율)</span></div><div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100"><span class="text-xs font-bold text-gray-500 w-20">정원</span><span class="text-sm text-gray-700 break-keep">클래스당 7명 · 분반 가능</span></div><div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100"><span class="text-xs font-bold text-gray-500 w-20">구성</span><span class="text-sm text-gray-700 break-keep">8주 · 주 1회 강의 3시간 + 1:1 멘토링 1시간</span></div><div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100"><span class="text-xs font-bold text-gray-500 w-20">수강료</span><span class="text-sm text-gray-700 break-keep">한국 계좌이체 ₩450,000 · 미국 Zelle·Venmo $330</span></div></div><p class="mt-6 flex flex-wrap gap-3"><a href="/basic-course.html" class="inline-flex items-center justify-center rounded-full bg-er-dark text-white px-5 py-2.5 text-sm font-bold shadow-soft hover:bg-gray-800 transition-colors">과정 안내 보기</a><a href="/#apply?track=paid&focus=enneagram_basic_october" class="inline-flex items-center justify-center rounded-full border border-er-accent/40 bg-er-accentLight/30 px-5 py-2.5 text-sm font-bold text-er-dark hover:border-er-accent transition-colors">지금 신청하기</a></p>' },
    ...
    programs: {
      ...
      view: {
        ...
        training: {
          title: 'ER 전문가 과정',
          desc: '기본과정, 2급 검정과 심화성장101, 1급 코치 트레이닝으로 이어지는 교육 여정입니다.',
          cards: [
            { b: 'Foundation', t: '에니어그램 기본과정', d: '8주 동안 핵심 이론과 ER 관점을 배우고 실제 적용의 기초를 세웁니다.', i: 'fas fa-chalkboard' },
            { b: 'Growth', t: '2급 검정 · 심화성장101', d: '기본과정 수료 후 병행 참여할 수 있으며, 101 참여에 2급 자격은 필요하지 않습니다.', i: 'fas fa-book-reader' },
            { b: 'Coach Training', t: '2027 코치 트레이닝 2기 · 1급 과정', d: '2급 자격과 101 수료 후 지원 가능. 2~12월 중 9개월 교육하며 5월·9월은 방학입니다.', i: 'fas fa-user-md' }
          ]
        }
      }
    },
