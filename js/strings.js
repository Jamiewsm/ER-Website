...
(function () {
  ...
  var S = {
    ...
    contentData: {
      ...
      notices: [
        { id: 7, tag: '모집중', title: '에니어그램 기본과정 8주 — 7월 개강', date: '2026-06-11', summary: '온라인 8주 · 1:1 멘토링 · 정원 10명 · 얼리버드 $270 (6/24까지)', body: '<p class="text-gray-600 leading-relaxed break-keep"><strong>ER 성경적 에니어그램 기본과정</strong>은 단순히 유형을 배우는 시간이 아니라, 하나님이 창조하신 나의 오리지널 디자인을 이해하고 복음 안에서 회복과 성장을 경험하는 8주 과정입니다.</p><div class="mt-6 grid gap-3"><div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100"><span class="text-xs font-bold text-gray-500 w-20">기간</span><span class="text-sm text-gray-700 break-keep">2026년 7월 개강 · 8주</span></div><div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100"><span class="text-xs font-bold text-gray-500 w-20">구성</span><span class="text-sm text-gray-700 break-keep">주 1회 강의 3시간 + 1:1 멘토링 1시간</span></div><div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100"><span class="text-xs font-bold text-gray-500 w-20">수강료</span><span class="text-sm text-gray-700 break-keep">$300 (USD) · 6/24까지 얼리버드 $270</span></div><div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100"><span class="text-xs font-bold text-gray-500 w-20">결제</span><span class="text-sm text-gray-700 break-keep">PayPal·Zelle 송금 (USD)</span></div><div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100"><span class="text-xs font-bold text-gray-500 w-20">정원</span><span class="text-sm text-gray-700 break-keep">최대 10명 · 입금 확인 순 확정</span></div></div><p class="mt-6 flex flex-wrap gap-3"><a href="/basic-course.html" class="inline-flex items-center justify-center rounded-full bg-er-dark text-white px-5 py-2.5 text-sm font-bold shadow-soft hover:bg-gray-800 transition-colors">과정 안내 보기</a><a href="/#apply?track=paid&amp;focus=enneagram_basic_july&amp;apply_source=notice" class="inline-flex items-center justify-center rounded-full border border-er-accent/40 bg-er-accentLight/30 px-5 py-2.5 text-sm font-bold text-er-dark hover:border-er-accent transition-colors">신청하기</a></p>' },
        ...
        { id: 1, tag: '모집중', title: 'ER 전문가 양성반 5기·6기 모집', date: '2026-06-11', summary: '7월 5기 개강, 9월 6기 개강 예정 — 8주 온라인 전문가 과정', body: '<p class="text-gray-600 leading-relaxed break-keep">에니어그램을 "아는 단계"에서 끝내지 않고, 삶과 코칭·강의 현장에 적용하는 단계까지 함께 가는 <strong>ER 전문가 양성반</strong>입니다. 매주 심화 수업과 과제, 1:1 멘토링과 강의 피드백을 통해 실제 현장에서 자신 있게 사용할 수 있도록 돕습니다.</p><div class="mt-6 grid gap-3"><div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100"><span class="text-xs font-bold text-gray-500 w-20">5기</span><span class="text-sm text-gray-700 break-keep">2026년 7월 개강</span></div><div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100"><span class="text-xs font-bold text-gray-500 w-20">6기</span><span class="text-sm text-gray-700 break-keep">2026년 9월 개강 예정</span></div><div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100"><span class="text-xs font-bold text-gray-500 w-20">구성</span><span class="text-sm text-gray-700 break-keep">8주 온라인 · 강의·과제·멘토링</span></div><div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100"><span class="text-xs font-bold text-gray-500 w-20">대상</span><span class="text-sm text-gray-700 break-keep">기독교 세계관 안에서 자기 이해와 타인 돌봄(코칭·강의)에 실제로 적용하고자 하는 분</span></div></div><p class="mt-6 flex flex-wrap gap-3"><a href="/#coach_training" class="inline-flex items-center justify-center rounded-full bg-er-dark text-white px-5 py-2.5 text-sm font-bold shadow-soft hover:bg-gray-800 transition-colors">양성반 안내 보기</a><a href="/#apply?track=paid" class="inline-flex items-center justify-center rounded-full border border-er-accent/40 bg-er-accentLight/30 px-5 py-2.5 text-sm font-bold text-er-dark hover:border-er-accent transition-colors">문의·신청하기</a></p>' },
