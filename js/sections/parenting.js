...
const PARENTING_ARTICLES = [
    {
        ...
        body: [
            '아이마다 스트레스를 드러내는 방식이 다릅니다. 어떤 아이는 말과 행동이 많아지고 사소한 일에도 날카로워집니다. 반대로 어떤 아이는 입을 닫고 방으로 들어가 혼자 있으려 합니다. 같은 "괜찮아"라는 한마디도 아이에 따라 전혀 다른 신호일 수 있습니다.',
            '스트레스 신호는 대개 "문제 행동"의 얼굴을 하고 찾아옵니다. 갑자기 늘어난 떼쓰기, 등교 거부, 동생에게 거칠어지는 태도는 그 자체가 문제라기보다, 감당하기 어려운 감정을 말로 옮기지 못해 행동으로 내보내는 경우가 많습니다.',
            '그래서 행동을 곧바로 고치려 하기 전에, 그 행동이 어떤 불편을 말하고 있는지 먼저 읽어보는 순서가 중요합니다. "왜 또 이래"라는 질문을 "지금 무엇이 힘들까"로 바꾸기만 해도, 같은 장면에서 부모의 첫 반응이 달라집니다.',
            '신호를 빨리 알아차리는 부모일수록 아이를 덜 오해합니다. 그리고 아이는 자신의 어려움이 받아들여진다는 경험을 쌓아갑니다. 그 작은 경험이 모일 때, 아이는 힘들 때 부모를 등지는 대신 부모에게로 돌아옵니다.'
        ],
        link: { label: '아이 관찰 체크리스트 보기', href: 'docs/parent_resources/child_type_checklist.html' },
        cta: { kind: 'child', blurb: '같은 행동도 아이마다 다른 욕구에서 나옵니다. 우리 아이가 무엇에 움직이는지 먼저 확인해 보세요.' }
    },
    {
        t: '아이에게 하지 말아야 할 말', i: 'fas fa-ban', tag: '대화',
        body: [
            '"왜 너만 그래?", "형은 안 그러는데" 같은 비교와 단정은 행동을 바꾸기보다 "나는 늘 부족하다"는 메시지로 남습니다. 부모는 잠깐의 답답함을 풀지만, 아이의 마음에는 자신에 대한 평가가 오래 새겨집니다.',
            '특히 "너는 왜 항상", "도대체 몇 번을 말해" 같은 표현은 한 번의 실수를 아이의 성격 전체로 확대합니다. 아이는 그 순간의 행동이 아니라 자기 존재가 문제라고 받아들이고, 다음에는 더 숨기거나 더 반항하게 됩니다.',
            '바꾸고 싶은 행동이 있다면, 아이의 존재가 아니라 구체적인 상황과 다음 행동을 짚어 말해 주세요. "지금 신발을 신어야 늦지 않아"처럼 행동과 이유를 함께 전하면, 아이는 비난이 아니라 정보를 듣습니다.',
            '무심코 나오는 말일수록 부모 자신의 익숙한 반응에서 비롯될 때가 많습니다. 어떤 말이 자꾸 튀어나오는지 살피는 일은 아이를 위한 일인 동시에, 나의 양육 패턴을 이해하는 출발점이기도 합니다.'
        ],
        link: { label: '부모 양육성향 특징 자료 보기', href: 'docs/parent_resources/mom_type_summary.html' },
        cta: { kind: 'parent', blurb: '자꾸 튀어나오는 말의 뿌리에는 부모의 익숙한 반응이 있습니다. 나의 양육성향부터 이해해 보세요.' }
    },
    {
        t: '칭찬과 훈육', i: 'fas fa-star', tag: '동기',
        body: [
            '칭찬은 결과가 아니라 시도와 과정에 할 때 자신감으로 이어집니다. "100점이라서 대단해"라는 말은 다음에 100점을 못 받으면 무너지지만, "어려운데 끝까지 해봤구나"라는 말은 다음 도전을 만듭니다.',
            '결과만 칭찬받은 아이는 실패가 두려워 새로운 것을 피하기 쉽습니다. 반대로 과정을 인정받은 아이는 잘 안 되더라도 다시 시도하는 힘을 기릅니다. 같은 칭찬도 어디에 초점을 두느냐가 아이의 태도를 바꿉니다.',
            '훈육도 마찬가지입니다. 감정을 쏟아내며 혼내는 순간 아이는 무엇을 잘못했는지보다 부모의 화부터 기억합니다. 무엇이 문제였고 다음엔 어떻게 할지를 차분히 함께 정리할 때, 아이는 비로소 배웁니다.',
            '아이마다 효과적인 칭찬과 훈육의 방식은 다릅니다. 인정이 중요한 아이와 자유가 중요한 아이에게 같은 말이 똑같이 통하지는 않습니다. 우리 아이가 무엇에 움직이는지 아는 것이 먼저입니다.'
        ],
        link: { label: '아이 관찰 체크리스트 보기', href: 'docs/parent_resources/child_type_checklist.html' },
        cta: { kind: 'child', blurb: '아이마다 통하는 칭찬과 훈육이 다릅니다. 우리 아이의 핵심 동기를 먼저 확인해 보세요.' }
    },
    {
        t: '사춘기 자녀와의 대화', i: 'fas fa-comment', tag: '사춘기',
        body: [
            '사춘기 아이의 침묵은 거절이 아니라, 자기만의 공간을 지키려는 신호일 때가 많습니다. 부모가 다가가려 할수록 더 문을 닫는 것처럼 보이지만, 그것은 미움이 아니라 독립을 향한 자연스러운 과정입니다.',
            '이 시기의 아이는 부모의 질문을 관심이 아니라 간섭으로 느끼기 쉽습니다. "오늘 학교 어땠어"라는 말에도 짧게 답하거나 방으로 들어가 버립니다. 대답이 없다고 해서 마음까지 닫힌 것은 아닙니다.',
            '대답을 재촉하기보다, 혼자 정리할 시간을 먼저 허용하고 짧게 곁을 지켜 주세요. 함께 차를 타거나 같은 화면을 볼 때처럼 눈을 맞추지 않아도 되는 순간에, 아이는 의외로 먼저 입을 엽니다. 대화는 타이밍이 절반입니다.',
            '중요한 것은 문이 닫혀 있을 때에도 부모가 떠나지 않는다는 신뢰입니다. 지금 말하지 않아도 언제든 돌아올 자리가 있다는 감각이, 사춘기를 지나는 아이에게 가장 든든한 안전망이 됩니다.'
        ],
        link: { label: '아이 관찰 체크리스트 보기', href: 'docs/parent_resources/child_type_checklist.html' },
        cta: { kind: 'child', blurb: '사춘기 아이의 반응 뒤에는 저마다의 욕구가 있습니다. 우리 아이의 성향을 먼저 이해해 보세요.' }
    },
    {
        t: '부모의 스마트폰 사용', i: 'fas fa-mobile-screen', tag: '습관',
        body: [
            '아이는 부모의 말보다 부모가 화면을 보는 시간을 더 오래 기억합니다. "스마트폰 그만"이라는 말의 설득력은 결국 부모의 손에서 나옵니다. 부모가 식탁에서도 화면을 들여다본다면, 아이에게 그 규칙은 공허하게 들립니다.',
            '아이는 부모가 자신보다 화면에 더 집중한다고 느낄 때 묘한 거절감을 경험합니다. 대화 도중 흘끔거리는 시선과 짧게 끊기는 대답이 쌓이면, 아이는 굳이 말을 걸지 않는 쪽을 택하게 됩니다.',
            '규칙을 정할 때 아이만의 규칙이 아니라 가족 공통의 약속으로 만들면, 통제가 아니라 함께 지키는 일이 됩니다. "저녁 8시 이후에는 거실에 두기"처럼 부모도 함께 따르는 기준이 아이에게 가장 강력한 메시지입니다.',
            '스마트폰을 손에서 놓기 어려운 순간이 언제인지 부모 스스로 살펴보는 것도 도움이 됩니다. 불안할 때인지 피곤할 때인지를 알면, 아이에게 요구하기 전에 나의 습관부터 이해하게 됩니다.'
        ],
        link: { label: '부모 양육성향 특징 자료 보기', href: 'docs/parent_resources/mom_type_summary.html' },
        cta: { kind: 'parent', blurb: '스마트폰을 놓기 어려운 순간에는 이유가 있습니다. 나의 양육성향과 패턴부터 살펴보세요.' }
    },
    {
        t: '스킨십과 경계', i: 'fas fa-hand', tag: '경계',
        body: [
            '어릴 때 좋아하던 포옹을 사춘기 아이가 갑자기 거절하는 것은 거리감이 아니라 경계의 발달입니다. 자기 몸과 공간에 대한 감각이 자라면서, 아이는 스스로 선을 긋는 법을 배우는 중입니다.',
            '이때 거절을 서운함으로 받아들여 "엄마가 미워?"라고 되물으면, 아이는 경계를 세우는 일에 죄책감을 느낍니다. 반대로 거절이 존중받은 아이는 자신의 경계를 지키면서도 관계를 신뢰하게 됩니다.',
            '신체 접촉은 아이의 속도에 맞추는 것이 좋습니다. 손을 내밀되 강요하지 않고, 아이가 다가올 여지를 남겨 두세요. 거절을 존중받은 아이가 오히려 더 안전하다고 느끼며 먼저 다가옵니다.',
            '경계를 세우는 연습은 가족 안에서 가장 안전하게 이루어집니다. 집에서 "싫어"라고 말할 수 있었던 아이가 바깥에서도 자신을 지키는 말을 할 수 있습니다. 거절을 받아주는 일은 아이를 보호하는 일이기도 합니다.'
        ],
        link: { label: '아이 관찰 체크리스트 보기', href: 'docs/parent_resources/child_type_checklist.html' },
        cta: { kind: 'child', blurb: '거절과 경계의 방식도 아이마다 다릅니다. 우리 아이의 성향을 먼저 이해해 보세요.' }
    },
    {
        t: '공부 동기', i: 'fas fa-book-open', tag: '동기',
        body: [
            '동기는 잔소리로 만들어지지 않습니다. 아이가 무엇을 중요하게 느끼는지에 따라 마음을 움직이는 말이 다릅니다. 인정이 중요한 아이와 자유가 중요한 아이에게 같은 말은 똑같이 통하지 않습니다.',
            '"이거 안 하면 나중에 후회해"라는 불안의 언어는 잠깐 효과가 있어도 오래가지 않습니다. 아이는 공부 자체가 아니라 부모의 불안을 떠안게 되고, 결국 공부를 부모의 일로 여기게 됩니다.',
            '성적이라는 결과보다, 아이가 스스로 정한 작은 목표와 그 과정을 함께 봐주는 편이 더 오래 갑니다. "오늘 30분 집중했네"처럼 스스로 통제할 수 있는 행동을 인정해 주면, 아이는 자신이 해낼 수 있다는 감각을 쌓습니다.',
            '무엇보다 공부가 부모의 사랑을 얻는 조건이 되지 않도록 조심해야 합니다. 잘하든 못하든 변하지 않는 관심이 있을 때, 아이는 비로소 실패를 두려워하지 않고 도전할 수 있습니다.'
        ],
        link: { label: '아이 관찰 체크리스트 보기', href: 'docs/parent_resources/child_type_checklist.html' },
        cta: { kind: 'child', blurb: '아이를 움직이는 동기는 저마다 다릅니다. 우리 아이가 무엇을 중요하게 느끼는지 확인해 보세요.' }
    },
    {
        t: '돈에 관한 부모의 언어', i: 'fas fa-coins', tag: '가치',
        body: [
            '용돈과 소비를 두고 하는 부모의 말에는 불안, 통제, 인정 욕구가 함께 담깁니다. 아이는 돈을 다루는 법을 배우기 전에, 돈에 대한 부모의 태도와 말투를 먼저 흡수합니다.',
            '"돈이 어디서 나오는 줄 알아?"라는 말이 반복되면, 아이는 돈을 죄책감과 연결합니다. 반대로 부모가 늘 불안 없이 다 사 준다면, 아이는 기다림과 선택의 경험을 놓칩니다. 두 극단 모두 돈을 건강하게 배우기 어렵게 만듭니다.',
            '제한을 둘 때도 이유와 기준을 함께 말해 주면, 돈은 다툼의 주제가 아니라 함께 배우는 주제가 됩니다. "이번 달 용돈은 여기까지야"에 그치지 않고 무엇을 기준으로 정했는지 나누면, 아이는 한계 안에서 선택하는 법을 익힙니다.',
            '돈에 관한 말이 유난히 날카로워지는 순간이 있다면, 그 뒤에 있는 부모 자신의 불안을 살펴볼 필요가 있습니다. 나의 돈에 대한 감정을 이해할수록, 아이에게 더 차분한 언어로 전할 수 있습니다.'
        ],
        link: { label: '부모 양육성향 특징 자료 보기', href: 'docs/parent_resources/mom_type_summary.html' },
        cta: { kind: 'parent', blurb: '돈에 관한 말이 날카로워지는 데에는 이유가 있습니다. 나의 양육성향부터 이해해 보세요.' }
    }
];
...
function openParentingArticle(index) {
    ...
    // 아티클 주제에 맞춘 퍼널 CTA — 아이중심 → 아이 유형검사, 부모중심 → 부모 양육성향 이해
    const ctaKinds = {
        child: { label: '아이 유형검사 시작하기', onclick: "document.getElementById('parenting-article-modal').remove(); window.location.href='child-type-test/child-type-test.html'" },
        parent: { label: '부모 양육성향 이해하기', onclick: "document.getElementById('parenting-article-modal').remove(); renderSection('parenting', { focus: 'parent' })" }
    };
    const cta = ctaKinds[a.cta?.kind] || ctaKinds.child;
    const ctaBlurb = a.cta?.blurb || '우리 아이의 반응이 유난히 이해하기 어렵다면, 행동 뒤에 있는 핵심 욕구를 먼저 확인해 보세요.';
        ...
        <div class="bg-white rounded-[2rem] w-full max-w-xl max-h-[82vh] overflow-y-auto shadow-2xl animate-fade-in-up">
            ...
            <div class="p-6">
                ...
                <div class="mt-6 rounded-2xl bg-er-base/60 border border-gray-100 p-5">
                    <p class="text-xs text-gray-600 break-keep mb-3">${ctaBlurb}</p>
                    <button onclick="${cta.onclick}" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-er-dark text-white text-xs font-bold hover:bg-gray-800 transition-colors">
                        ${cta.label} <i class="fas fa-arrow-right text-[10px]"></i>
                    </button>
                </div>
            </div>
        </div>
