...
(function exposeTestShared(globalScope) {
  // 9 type 의 스트레스/통합 화살표 (Chestnut + Riso-Hudson 표준).
  const sharedArrowLines = {
    1: { stress: 4, growth: 7 },
    2: { stress: 8, growth: 4 },
    3: { stress: 9, growth: 6 },
    4: { stress: 2, growth: 1 },
  ...
  const TestShared = { arrowLines: sharedArrowLines, INSTINCT_LABELS, TYPE_NAMES };

  if (typeof module !== 'undefined' && module.exports) {
    module.exports = TestShared;
  }
  if (globalScope) {
    globalScope.TestShared = Object.assign(globalScope.TestShared || {}, TestShared);
  }
