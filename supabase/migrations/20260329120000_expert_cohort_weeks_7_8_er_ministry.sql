-- 전문가 양성반 7·8주차 (ER 사역 / er_ministry), 6주차와 동일 요일(목)·슬롯·줌
-- (초안은 4/7·4/14 화요일로 잘못 들어가 있었음 → 4/9·4/16 목요일로 정정)
-- Idempotent: aligns 6주차 row with er_ministry if still on older seed
