...
1. `sx_7_w8.json` 골드 샘플을 사용자가 실제 결과지/PDF에서 검토합니다.
2. Type 7 draft batch 5개를 Anara/source review와 톤 승인 후 승격합니다.
3. 다음 확장 배치를 countertype set 또는 사용자 제공 Anara exports로 정합니다.
...
54개 조합의 현재 진행률은 아래 명령으로 확인합니다. 현재 Type 7 전체 6개 조합이 준비되어 `6/54`를 기대합니다.
